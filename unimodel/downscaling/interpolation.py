...
def bilinear(
    ...
    grid_interp = reproject_xarray(
        data, dest_proj, grid_shape, corner_ul, grid_res, resampling=Resampling.bilinear
    )
...
def nearest(
    ...
    grid_interp = reproject_xarray(
        data, dest_proj, grid_shape, corner_ul, grid_res, resampling=Resampling.nearest
    )
