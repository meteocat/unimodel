...
def proj4_from_grib(ds_grib: xarray.DataArray) -> dict:
    ...
    if 'GRIB_radius' in attributes:
        ...
        if attributes['GRIB_shapeOfTheEarth'] == 6:
            ...
            if ('GRIB_scaleFactorOfMajorAxisOfOblateSpheroidEarth'
               in attributes):
                scalea = attributes['GRIB_scaleFactorOfMajorAxisOf'
                                    'OblateSpheroidEarth']
                scaleb = attributes['GRIB_scaleFactorOfMinorAxisOf'
                                    'OblateSpheroidEarth']
                ...
                scalea = 1.
                scaleb = 1.
                projparams['a'] = attributes['GRIB_scaledValueOfEarth'
                                             'MajorAxis'] * scalea
                projparams['b'] = attributes['GRIB_scaledValueOfEarth'
                                             'MinorAxis'] * scaleb
            ...
            if 'GRIB_scaleFactorOfRadiusOfSphericalEarth' in attributes:
                ...
                scalea = 1.
                scaleb = 1.
            projparams['a'] = attributes['GRIB_scaledValueOfRadiusOf'
                                         'SphericalEarth'] * scalea
            projparams['b'] = attributes['GRIB_scaledValueOfRadiusOf'
                                         'SphericalEarth'] * scaleb
    ...
    if attributes['GRIB_gridType'] in ['reduced_gg', 'reduced_ll',
        ...
        projparams['lon_0'] = attributes['GRIB_longitudeOfSubSatellite'
                                         'PointInDegrees']
        projparams['lat_0'] = attributes['GRIB_latitudeOfSubSatellite'
                                         'PointInDegrees']
