...
class Test_XarrayTools(unittest.TestCase):
    ...
    def test_expand_valid_time_coord(self):
        ...
        self.assertEqual(xarray_padded.valid_time[0],
                         np.datetime64('2023-02-15T03:00:00.000000000'))
        self.assertEqual(xarray_padded.valid_time[-1],
                         np.datetime64('2023-02-18T02:00:00.000000000'))
        self.assertEqual(xarray_padded.valid_time[8],
                         np.datetime64('2023-02-15T11:00:00.000000000'))
        ...
        self.assertEqual(xarray_padded.valid_time[0],
                         np.datetime64('2023-02-15T03:00:00.000000000'))
        self.assertEqual(xarray_padded.valid_time[-1],
                         np.datetime64('2023-02-17T21:00:00.000000000'))
        self.assertEqual(xarray_padded.valid_time[8],
                         np.datetime64('2023-02-17T03:00:00.000000000'))
        self.assertAlmostEqual(float(xarray_padded[0][200][200].data), 0.0)
        self.assertTrue(np.isnan(xarray_padded[8][200][200].data))

        xarray_padded = expand_valid_time_coord(self.concat_data, lead_time=72,
                                                interval=1)
        self.assertEqual(xarray_padded.shape, (72, 417, 620))
        self.assertEqual(xarray_padded.valid_time[0],
                         np.datetime64('2023-02-15T03:00:00.000000000'))
        self.assertEqual(xarray_padded.valid_time[1],
                         np.datetime64('2023-02-15T04:00:00.000000000'))
        self.assertEqual(xarray_padded.valid_time[-1],
                         np.datetime64('2023-02-18T02:00:00.000000000'))
        self.assertAlmostEqual(float(xarray_padded[0][200][200].data), 0.0)
        self.assertTrue(np.isnan(xarray_padded[8][200][200].data))
    ...
    def test_expand_valid_time_coord_wrong_interval(self):
        ...
        self.assertEqual('\'interval\' is different than temporal '
    ...
    def test_expand_valid_time_coord_multiple_interval(self):
        ...
        self.assertEqual('\'lead_time\' is not a multiple of \'interval\'. '
    ...
    def test_expand_valid_time_coord_valid_time_not_found(self):
        ...
        self.assertEqual('\'valid_time\' not in data coordinates.',
                         err.exception.args[0])
